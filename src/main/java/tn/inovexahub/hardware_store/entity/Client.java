...
public class Client {
  ...
  @Schema(description = "Unique client ID", example = "1", accessMode = Schema.AccessMode.READ_ONLY)
  @Id
  ...
  @Schema(
      description =
          "Current outstanding debt (computed automatically from credit history; "
  ...
  @Schema(
      description = "Whether client is soft deleted (managed via the delete endpoint)",
      example = "false",
      accessMode = Schema.AccessMode.READ_ONLY)
